    ...
    for (const [i, l] of leadersData.entries()) {
      await prisma.teamMember.create({
        data: {
          ...
          translations: {
            create: [
              { lang: 'ru', name: l.name, position: l.role, bio: l.bio, fullBio: l.fullBio },
              { lang: 'kz', name: l.name, position: l.role, bio: l.bio, fullBio: l.fullBio },
            ],
          },
        },
      });
