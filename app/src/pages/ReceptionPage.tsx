    ...
    <div className="pt-[104px] pb-16">
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <ScrollReveal>
            <div className="bg-surface rounded-panel p-6 md:p-8">
              ...
              {submitted ? (
                <div className="bg-red/10 border border-red/25 rounded-card p-6 text-center">
                  ...
                  {appealNumber && <p className="text-body text-text-base mt-2">Номер обращения: <strong>{appealNumber}</strong></p>}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <select value={formData.topic} onChange={e => setFormData({ ...formData, topic: e.target.value })}
                    ...
                    <option value="" className="bg-surface text-text-muted">Выберите тему</option>
          ...
          <div className="space-y-5">
            <ScrollReveal delay={0.1}>
              <a href="https://wa.me/77000881917" target="_blank" rel="noopener noreferrer"
                ...
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-[20px] font-bold text-text-base">+7 700 088 19 17</span>
                </div>
                <p className="text-body text-text-muted">Написать напрямую</p>
              </a>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2}>
              <div ref={counterRef} className="bg-red/[0.08] border border-red/25 rounded-[16px] p-5 md:p-6">
                ...
                <p className="text-body text-text-muted mt-1">обращений решено</p>
              </div>
            </ScrollReveal>
