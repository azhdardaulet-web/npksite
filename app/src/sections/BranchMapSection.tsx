...
// ─── Branch data ──────────────────────────────────────────────────────────────
const BRANCHES = [
  { name:'Алматинский городской филиал',           short:'Алматы',                       city:true,  lng:76.889, lat:43.238, chairman:'Кусаинов Бейбит Булатович',          email:'halykparty_almaty@qhp.kz',          address:'050000, г. Алматы, ул. Қазыбек би 22, БЦ Жан-Ер, офис 222',              phone:'+7 778 788 2034' },
  { name:'Астанинский городской филиал',            short:'Астана',                        city:true,  lng:71.449, lat:51.169, chairman:'Оразханов Нұрдәулет Амантайұлы',     email:'halykparty_astana@qhp.kz',          address:'010000, г. Астана, ул. Желтоксан, 16, НП 2',                              phone:'+7 702 796 4570' },
  { name:'Шымкентский городской филиал',            short:'Шымкент',                       city:true,  lng:69.587, lat:42.317, chairman:'Умаров Баймырза Абденбаевич (и.о.)', email:'halykparty_shymkent@qhp.kz',        address:'160011, г. Шымкент, ул. Д. Кунаева 20/1',                                phone:'—' },
  { name:'Акмолинский областной филиал',            short:'Акмолинская область',           city:false, lng:69.388, lat:53.284, chairman:'Тастамбеков Арман Зейнуллаевич',      email:'halykparty_akmola@mail.ru',         address:'020000, г. Кокшетау, ул. М. Дулатулы, 31',                               phone:'+7 775 212 9293' },
  { name:'Актюбинский областной филиал',            short:'Актюбинская область',           city:false, lng:57.166, lat:50.283, chairman:'Курмангазин Бауыржан Олжашевич',      email:'halykparty_aktobe@qhp.kz',          address:'030002, г. Актобе, ул. Мангилик Ел, здание 7 «Б», каб. 603',            phone:'+7 778 803 3848' },
  { name:'Алматинский областной филиал',            short:'Алматинская область',           city:false, lng:77.07,  lat:43.86,  chairman:'Дудабаев Еркебулан Бакытович (и.о.)',email:'halykparty_almaty_obl@qhp.kz',      address:'040800, г. Конаев, ул. Достык, 5, каб. 20',                              phone:'—' },
  { name:'Атырауский областной филиал',             short:'Атырауская область',            city:false, lng:51.923, lat:47.094, chairman:'Досмухамбетова Балжан Ибатовна',      email:'halykparty_atyrau@qhp.kz',          address:'060000, г. Атырау, ул. М. Утемисова 134 А, БЦ «Евразия», 5 этаж',      phone:'+7 778 485 4437' },
  { name:'Восточно-Казахстанский областной филиал', short:'Восточно-Казахстанская область',city:false, lng:82.628, lat:49.948, chairman:'Мусин Кайрат Маратович',               email:'halykparty_vko@qhp.kz',             address:'070000, г. Усть-Каменогорск, ул. М. Горького, 46, офис 211',            phone:'+7 7232 24 4648 / +7 777 256 8539' },
  { name:'Жетысуский областной филиал',             short:'Жетысуская область',            city:false, lng:78.374, lat:45.016, chairman:'Ибраимов Олжас Бекдаулетович',        email:'halykparty_taldykorgan@qhp.kz',    address:'040000, г. Талдыкорган, пр. Н. Назарбаева, 44, каб. 22',               phone:'+7 701 149 9555' },
  { name:'Жамбылский областной филиал',             short:'Жамбылская область',            city:false, lng:71.367, lat:42.9,   chairman:'Аккозиев Рахман Сейлханович',         email:'halykparty_zhambyl@qhp.kz',         address:'080000, г. Тараз, ул. Казыбек би, 109А, офис 3',                         phone:'—' },
  { name:'Западно-Казахстанский областной филиал',  short:'Западно-Казахстанская область', city:false, lng:51.387, lat:51.227, chairman:'Лаврентьев Борис Георгиевич',          email:'halykparty_zko@mail.ru',            address:'090000, г. Уральск, ул. Ихсанова, 38, каб. 207',                         phone:'+7 7112 25 3445 / +7 705 570 7517' },
  { name:'Карагандинский областной филиал',         short:'Карагандинская область',        city:false, lng:73.085, lat:49.806, chairman:'Максутов Калел Мухатаевич',             email:'halykparty_karaganda@qhp.kz',       address:'100000, г. Караганда, ул. Алиханова, 5, каб. 300–302',                   phone:'+7 701 512 5129' },
  { name:'Костанайский областной филиал',           short:'Костанайская область',          city:false, lng:63.632, lat:53.214, chairman:'Березуцкая Ольга Ивановна',             email:'halykparty.kostanai@mail.ru',       address:'110000, г. Костанай, ул. Байтурсынова, 95, каб. 332, 333',              phone:'+7 7142 53 4571 / +7 747 819 6974' },
  { name:'Филиал области Абай',                     short:'Область Абай',                  city:false, lng:80.227, lat:50.411, chairman:'',                                      email:'halykparty.semey@mail.ru',          address:'г. Семей, ул. Мәңгілік ел 9, каб. 310',                                  phone:'—' },
  { name:'Кызылординский областной филиал',         short:'Кызылординская область',        city:false, lng:65.482, lat:44.848, chairman:'Ерназаров Кайрат Шаршыбекович',        email:'halykparty_kyzylorda@qhp.kz',       address:'120000, г. Кызылорда, ул. Кунаева 10, 1 этаж, офис 1, 2',              phone:'+7 700 500 3484 / +7 776 070 2121' },
  { name:'Мангистауский областной филиал',          short:'Мангистауская область',         city:false, lng:51.198, lat:43.641, chairman:'Тулеугалиев Рашид Бектурович (и.о.)',  email:'halykparty_mangistau@qhp.kz',       address:'130000, г. Актау, 14 мкр, зд. 61/1, БЦ «Звезда Актау», каб. 305',    phone:'+7 778 572 0073 / +7 778 572 1333' },
  { name:'Павлодарский областной филиал',           short:'Павлодарская область',          city:false, lng:76.967, lat:52.287, chairman:'Агибаев Алимбек Тулегенович (и.о.)',   email:'halykparty.pavlodar@mail.ru',       address:'140000, г. Павлодар, ул. Маргулана, 110, офис 4',                        phone:'+7 701 756 9763' },
  { name:'Северо-Казахстанский областной филиал',   short:'Северо-Казахстанская область',  city:false, lng:69.163, lat:54.873, chairman:'Жумагулов Ергали Сергалиевич',          email:'halykparty_sko@mail.ru',            address:'150000, г. Петропавловск, ул. Ы. Алтынсарина 166, офис 405',           phone:'+7 7152 36 5916' },
