...
export const regions: Region[] = [
  { id: 'almaty',      name: 'Алматы (г.)',                      chairman: 'Кусаинов Бейбит Булатович',        address: '050000, г. Алматы, ул. Қазыбек би 22, БЦ Жан-Ер, офис 222',                              phone: '+7 778 788 2034', email: 'halykparty_almaty@qhp.kz' },
  ...
  { id: 'vko',       name: 'Восточно-Казахстанская обл.',       chairman: 'Мусин Кайрат Маратович',           address: '070000, г. Усть-Каменогорск, ул. М. Горького, 46, офис 211',                            phone: '+7 7232 24 4648 / +7 777 256 8539', email: 'halykparty_vko@qhp.kz' },
  ...
  { id: 'zko',       name: 'Западно-Казахстанская обл.',        chairman: 'Лаврентьев Борис Георгиевич',      address: '090000, г. Уральск, ул. Ихсанова, 38, каб. 207',                                         phone: '+7 7112 25 3445 / +7 705 570 7517', email: 'halykparty_zko@mail.ru' },
  ...
  { id: 'kostanay',  name: 'Костанайская обл.',                 chairman: 'Березуцкая Ольга Ивановна',        address: '110000, г. Костанай, ул. Байтурсынова, 95, каб. 332, 333',                              phone: '+7 7142 53 4571 / +7 747 819 6974', email: 'halykparty.kostanai@mail.ru' },
  { id: 'abay',      name: 'Область Абай',                      chairman: '—',                                address: 'г. Семей, ул. Мәңгілік ел 9, каб. 310',                                                  phone: '—',               email: 'halykparty.semey@mail.ru' },
  { id: 'kyzylorda', name: 'Кызылординская обл.',               chairman: 'Ерназаров Кайрат Шаршыбекович',    address: '120000, г. Кызылорда, ул. Кунаева 10, 1 этаж, офис 1, 2',                              phone: '+7 700 500 3484 / +7 776 070 2121', email: 'halykparty_kyzylorda@qhp.kz' },
  { id: 'mangistau', name: 'Мангистауская обл.',                chairman: 'Тулеугалиев Рашид Бектурович (и.о.)', address: '130000, г. Актау, 14 мкр, зд. 61/1, БЦ «Звезда Актау», каб. 305',                    phone: '+7 778 572 0073 / +7 778 572 1333', email: 'halykparty_mangistau@qhp.kz' },
