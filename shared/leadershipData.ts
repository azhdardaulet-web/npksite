...
export const LEADERSHIP_FALLBACK = [
  {
    ...
    name: 'Шоканов Нурсултан Нурланович', position: 'Председатель партии',
...
• Финансы, инвестиции и корпоративные финансы`,
  },
  {
    ...
    name: 'Кусаинов Бейбит Булатович', position: 'Заместитель Председателя партии',
...
• Переговоры, международное сотрудничество и организационное развитие`,
  },
  {
    ...
    name: 'Аукенов Мирас Серикбекович', position: 'Заместитель Председателя партии',
...
• Проектное управление`,
  },
  {
    ...
    name: 'Курманбаев Жандос Конспаевич', position: 'Заместитель Председателя партии по стратегии и идеологии',
...
• Цифровые медиа, аналитика и общественное позиционирование`,
  },
  {
    ...
    name: 'Максутов Калел Мукатаевич', position: 'Заместитель Председателя партии',
...
• Взаимодействие с общественными институтами`,
  ...
  {
    id: '6', photoUrl: '/images/leader-kulenova.jpg', slug: 'kulenova-lejla', group: 'LEADERSHIP' as const, sortOrder: 5,
    name: 'Куленова Лейла Искандеровна', position: 'Заместитель Председателя партии',
    bio: 'Общественный деятель, предприниматель и эксперт в сфере образовательной политики. Развивает женское предпринимательство и систему непрерывного образования.',
    fullBio: `ОБЩАЯ ИНФОРМАЦИЯ
...
• Долгосрочные и устойчивые управленческие решения`,
  },
  {
    id: '7', photoUrl: '/images/leader-zhumat.jpg', slug: 'zhumat-ilmira', group: 'LEADERSHIP' as const, sortOrder: 6,
    name: 'Ильмира Жумат', position: 'Заместитель Председателя партии по вопросам медиа',
    bio: 'Казахстанский журналист, медиаменеджер и эксперт в области стратегических коммуникаций. Курирует информационную политику и медиаресурсы партии.',
    fullBio: `ОБЩАЯ ИНФОРМАЦИЯ

Ильмира Жумат — заместитель Председателя Народной партии Казахстана по вопросам медиа, казахстанский журналист, медиаменеджер и эксперт в области стратегических коммуникаций.

Более 15 лет работает в сфере журналистики, медиаменеджмента и информационной политики. Прошла путь от редактора и телеведущей до руководителя медиа-направления Народной партии Казахстана. Имеет опыт разработки коммуникационных стратегий, управления медиапроектами и взаимодействия со средствами массовой информации.

ПРОФЕССИОНАЛЬНАЯ ДЕЯТЕЛЬНОСТЬ

Трудовую деятельность начала в АО РТРК «Казахстан».

В разные годы работала на телеканалах «Мәдениет», «Хабар», «Хабар 24», Silk Way, была автором и ведущей аналитического проекта BaigeNews.kz.

Участвовала в создании общественно-политических и аналитических проектов, руководила подготовкой телевизионного контента, развитием цифровых медиаплатформ и реализацией коммуникационных проектов республиканского уровня.

НАРОДНАЯ ПАРТИЯ КАЗАХСТАНА

С февраля 2024 года по июнь 2026 года занимала должность главного редактора медиаресурсов Народной партии Казахстана.

Инициировала создание новых цифровых медиапроектов партии и сформировала современную модель партийных коммуникаций. Руководила разработкой и реализацией коммуникационной стратегии, развитием официальных медиаресурсов и информационным сопровождением ключевых партийных инициатив и общественных проектов.

С июля 2026 года занимает должность заместителя Председателя Народной партии Казахстана по вопросам медиа.

Курирует информационную политику, стратегические коммуникации и взаимодействие со средствами массовой информации. Координирует деятельность пресс-службы, редакции, видеопродакшена, digital-направления и региональных медиаресурсов, обеспечивая реализацию единой коммуникационной стратегии партии.`,
  },
];
