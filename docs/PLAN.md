...
- Выполнен пакет правок от 23.07.2026: старое видео главной удалено, новые RU/KZ-видео закреплены без устаревшего CMS-фолбэка; «СМИ о нас» скрыт и перенаправляет в новости; WhatsApp изменён на +77002202020; добавлены локальные RU/KZ-образцы обращений.
- Предвыборная программа полностью заменена по новым выжимкам на русском и казахском языках, включая блок главной и бегущую строку; старые программные лозунги в разделе «О партии» заменены на «Богатство страны на благо народа!» / «Ел байлығы – халық игілігіне!».
- Восстановлен раздел «Народный подкаст» с аудиозаписями старого сайта; карточки проектов приведены к равномерной сетке; фотографии социальных групп заменены предоставленными SVG-иконками.
- Во фракции номер созыва приведён к римскому `VIII`; в казахской версии архива показываются только депутатские запросы с казахскими заголовками.
- Formular закреплён как единый шрифт сайта (заголовки Bold, основной текст Regular); на мобильных горизонтальные ScrollReveal-анимации заменены вертикальными. Основные маршруты проверены при ширине 390 px без горизонтального переполнения.
