...
- Начата редакторская проверка казахской версии по документу «каз ПРАВКИ по сайту»: история партии за 2011–2022 годы сверена с официальным сайтом, добавлен казахский текст события 2026 года; локализованы страницы «О партии», «Проекты», «Контакты», «БАҚ біз туралы», ключевые блоки главной, приёмной и фракции; название медиапроекта «Ақпар» сохранено без изменений.
- Завершён второй этап проверки казахской версии: переведены карточки и биографии руководства, медиапроекты, новости и поиск, пресс-кит, страницы всех проектов, интерфейс филиалов и сведения о депутатах с официальных казахских страниц; локализованы футер и хлебные крошки, магазин оставлен скрытым из навигации.
