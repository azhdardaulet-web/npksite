...
Актуальная CMS/CRM-архитектура (адаптация `cms/`, роли, схема БД, интеграции SMS/Telegram/Claude API/Daily.co) описана в [docs/PLAN.md](docs/PLAN.md) — это основной план работ по Блоку 2 ТЗ, следуй ему пошагово (Этапы 0–9). Секреты `cms/` — только в `cms/.env` (не коммитить, уже в `.gitignore`).
